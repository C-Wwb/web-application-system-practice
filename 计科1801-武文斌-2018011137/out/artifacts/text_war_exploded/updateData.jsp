<%@ page import="com.wwb.connection.jdbcUpdate" %><%--
...
<form name = "qd" onsubmit="return check()" action="text.jsp">
    <%
        ...
        jdbcUpdate ju = new jdbcUpdate();
        ju.setUserName(name);
        ju.setUserPassword(pwd);
        ju.setYear(year);
        ju.setMonth(month);
        ju.setDay(day);
        ju.setUserBloodType(xue);
        ju.setUserAddress(area);
        ju.setUserEmail(email);
        ju.update();
%>
